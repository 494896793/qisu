...
/**
 * 717219917@qq.com 2018/7/16 10:35.
 */
public class Adapter_Fragment_MyTrip_Underway extends BaseAdapter {

    private Context context;
    private List<Bean_TripNo.MyOrderList> list;

    public Adapter_Fragment_MyTrip_Underway(Context context, List<Bean_TripNo.MyOrderList> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        Adapter_Fragment_MyTrip_No.MyViewHolder_Term holder;
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.item_mytrip_underway, parent, false);
            holder = new Adapter_Fragment_MyTrip_No.MyViewHolder_Term(convertView);
            convertView.setTag(holder);
        } else {
            holder = (Adapter_Fragment_MyTrip_No.MyViewHolder_Term) convertView.getTag();
        }
        ...
        holder.mytrip_item_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    Intent intent = new Intent(context, Activity_MyTrip_Underway.class);
