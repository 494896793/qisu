...
public class UnderLineLinearLayout extends LinearLayout {
    ...
    public UnderLineLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int iconRes = attr.getResourceId(R.styleable.UnderLineLinearLayout_icon_src, R.mipmap.ic_charge_tag);//ic_ok
    ...
    private void drawLastChildViewVertical(Canvas canvas) {
        if (getChildAt(getChildCount() - 1) != null) {
            ...
            //记录值
            lastX = (sideRelative>=rootMiddle?(sideRelative-lineMarginSide):(sideRelative+lineMarginSide)) - (mIcon .getWidth() >> 1);
