...
//			options.icon(BitmapDescriptorFactory .fromBitmap(getViewBitmap(getView(size))));
                ...
                type_tmp = type_tmp.substring(type_tmp.indexOf(",") + 1, type_tmp.indexOf("."));//新添加数字   可用总数
...
//			size= Double.valueOf(type_tmp2).intValue();
    ...
    public View getView(int num) {
        View view = LayoutInflater.from(context).inflate(R.layout.view_carshare_juhe2, null);
...
//		img_portrait.setImageResource(R.mipmap.car_near2);
