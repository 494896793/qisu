...
public class ActivityController {
	...
	public Activity putActivity(Activity activity) {
		return activityMap.put(activity.getClass().getSimpleName(), activity);
	}
	/**
	 ...
	 */
	public void closeAllActivityExceptOne(Class<? extends  BaseActivity> clazz) {
		String aname = clazz.getSimpleName();
		Set<String> activityNames = activityMap.keySet();
		Activity activity = activityMap.get(aname);
