...
//        map.put("charging_gun", sb_with_gun.isChecked() ? "0":null);
    ...
    private void initTitleBar() {
        ...
        title.setText(R.string.charging_filter_title);
        ...
        right_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DialogHelper.confirmDialog(ChargingFilterActivity.this, getString(R.string.dialog_prompt_reset_filter), new AlertDialog.OnDialogButtonClickListener() {
