...
public class ChargingRecordAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.tv_payment_amount.setText("￥" + list.get(position).getPayMoney());
        holder.tv_actual_amount.setText("￥" + list.get(position).getRealMoney());
        holder.tv_return_amount.setText("￥" + list.get(position).getRebackMoney());
