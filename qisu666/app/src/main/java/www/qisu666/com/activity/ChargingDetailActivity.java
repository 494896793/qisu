        ...
        MyNetwork.getMyApi()
                ...
                .subscribe(new ResultSubscriber<Object>() {
                    ...
                    public void onSuccess(Object bean) {
                        ...
                        tv_start_time.setText(StringUtil.formatDate(jsonToMap.get("startChargeTime").toString()));
                        tv_end_time.setText(StringUtil.formatDate(jsonToMap.get("endChargeTime").toString()));
