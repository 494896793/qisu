...
//充电桩定位
public class ChargingOwnerActivity extends BaseActivity implements View.OnClickListener, LocationSource,
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_submit:
                DialogHelper.confirmDialog(ChargingOwnerActivity.this, getString(R.string.dialog_prompt_charging_owner), new AlertDialog.OnDialogButtonClickListener() {
                    @Override
    ...
    private void setUpMap() {
        ...
        myLocationStyle.myLocationIcon(BitmapDescriptorFactory
                .fromResource(R.mipmap.ic_nearby_charge));// 设置小蓝点的图标
        myLocationStyle.strokeColor(android.R.color.transparent);// 设置圆形的边框颜色
        myLocationStyle.radiusFillColor(android.R.color.transparent);// 设置圆形的填充颜色
...
//                LogUtils.d("定位啦啦啦啦啦！！！");
    ...
    private void submitToServer() {
        ...
        new HttpLogic(ChargingOwnerActivity.this).sendRequest(Config.REQUEST_URL, jsonObject, new AbstractResponseCallBack() {
            @Override
            public void onResponse(Map<String, Object> map, String tag) {
                ToastUtil.showToast(R.string.toast_B106);
            }
        });
    }
    ...
    public void onRegeocodeSearched(RegeocodeResult regeocodeResult, int rCode) {
        if (rCode == 1000) {
            if (regeocodeResult != null && regeocodeResult.getRegeocodeAddress() != null
                ...
                LogUtils.d(regeocodeResult.getRegeocodeAddress().getFormatAddress());
            } else {
