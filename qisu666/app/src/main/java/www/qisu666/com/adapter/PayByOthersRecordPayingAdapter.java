...
import java.util.Map;
 ...
 //他人代付中适配器
public class PayByOthersRecordPayingAdapter extends PullRefreshLoadRecyclerView.LoadRefreshAdapter<PayByOthersRecordPayingAdapter.MyViewHolder> {
    ...
    public PayByOthersRecordPayingAdapter(Context context, OnLoadRefreshCallBack listener, List<Map<String, Object>> list) {
    ...
    @Override
    public PayByOthersRecordPayingAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        MyViewHolder holder =  new MyViewHolder(LayoutInflater.from(context).inflate(R.layout.item_rv_pay_by_others_record_paying, parent, false));
        return holder;
    }

    @Override
    public void onBindViewHolder(PayByOthersRecordPayingAdapter.MyViewHolder holder, int position) {
