...
import www.qisu666.com.adapter.PayByOthersRecordPayingAdapter;
 ...
 */
public class PayByOthersRecordPayingFragment extends BaseFragment implements OnLoadRefreshCallBack {

    private View view;

    private PullRefreshLoadRecyclerView pull_refresh_load_recycler_view;
    private LoadMoreView loadMoreView;
    private PayByOthersRecordPayingAdapter adapter;
    ...
    public PayByOthersRecordPayingFragment() {
...
//        }
        ...
        adapter = new PayByOthersRecordPayingAdapter(getActivity(), this, list);
