...
//	private static String DB_PATH = "/data/data/www.qisu666.com/databases/";
	private static String DB_PATH = IDianNiuApp.getInstance().getFilesDir().getParentFile().getPath()+"/databases/";//兼容路径问题
	/*
